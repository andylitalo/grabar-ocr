...
_Updated 2026-06-07 · baseline vs corrected CER, over-correction, and per-page cost. Gate: page_0400 ≤0.3%; clear net reduction on page_0251/page_0499; over-correction ≈ 0. gpt-5.5 omitted (OpenAI key has no quota). Sonnet 4.6 over-thinks to the token cap under adaptive thinking and never emits the answer (parse_ok False → baseline)._
